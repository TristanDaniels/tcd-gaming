<template>
  <section id="about">
    ...
    <h5 class="ms-4 me-4">
      ...
      are many similar stories but Tristan decided to take it to the next level.
      Opening a gaming store. He always loved gaming but did he really see
      himself selling them? Well apparently yes. After planning his business
      since March 2021 he finally opened it in August 2022 and now we're up and
      running and providing fellow gamers with the best discs in the game!
    </h5>
    ...
    <h5 class="ms-4 me-4 mb-4">
      ...
      us via our contact page. A member from our support team will gladly be at
      your service.
    </h5>
...
<style scoped>
#about {
  background-image: url(https://i.postimg.cc/0NRKLhp2/About.jpg);
  background-size: 100%;
